...
const Post = (props) => {
  ...
  const onDonatePress = () => {
    const donatesToAdd = isDonate ? -1 : 1;
    setPost({
      ...post,
      donate: post.donate + donatesToAdd,
    });
      ...
      <TouchableWithoutFeedback onPress={onPlayPausePress}>
        <View>
          ...
          <View style={styles.uiContainer}>
             ...
             <TouchableOpacity style={styles.iconContainer} onPress={onDonatePress}>
                <FontAwesome5 name={'donate'} size={40} color={isDonate ? 'green' : 'white'} />
